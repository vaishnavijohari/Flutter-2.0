...
final allCrosswordPuzzles = [
  // Level 1: General Knowledge (Redesigned to be interconnected)
  CrosswordPuzzle(
    title: "LEVEL 1",
    rows: 13,
    cols: 12,
  ...
  CrosswordPuzzle(
    ...
    words: [
      ...
      CrosswordWord(id: 3, direction: CrosswordDirection.across, word: "GABRIEL", hint: "Archangel Who Delivered Divine Messages", startRow: 8, startCol: 7),
  ...
  CrosswordPuzzle(
    ...
    words: [
      ...
      CrosswordWord(id: 4, direction: CrosswordDirection.across, word: "JAIPUR", hint: "The Pink City Of India", startRow: 9, startCol: 6),
  ...
  CrosswordPuzzle(
    ...
    cols: 10,
    words: [
      CrosswordWord(id: 1, direction: CrosswordDirection.across, word: "SHAKESPEARE", hint: "Famous English Playwright", startRow: 1, startCol: 3),
      ...
      CrosswordWord(id: 6, direction: CrosswordDirection.down, word: "PETRA", hint: "Historic Rock-Cut City In Jordan", startRow: 0, startCol: 10),
      CrosswordWord(id: 7, direction: CrosswordDirection.down, word: "EXODUS", hint: "Mass Departure; Second Book Of The Bible", startRow: 1, startCol: 13),
    ],
  ),
];
